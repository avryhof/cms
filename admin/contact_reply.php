      ...
      <div class="row">
        ...
        <div class="row">
        	<div class="col-xs-12 col-sm-8">
            	<form action="../admin/contact_reply_save.php" method="post" class="form">
        		<input type="hidden" name="action" value="<?= $action; ?>">
        		<input type="hidden" name="contact" value="<?= $id; ?>">
                
                <div class="btn-group">
                    <a href="../admin/contact.php?id=<?= $id; ?>" class="btn btn-default"><i class="fa fa-chevron-left"></i> Back</a>
                    <button type="submit" class="btn btn-success">Send <i class="fa fa-chevron-right"></i></button>
                </div>
                ...
                <div class="form-group">
					...
					<? while($adminuser = $adminusers->fetch_assoc()) { ?>
                        <option value="<?= $adminuser['username']; ?>" <?= ($_SERVER['PHP_AUTH_USER'] == $adminuser['username'] ? 'selected' : ''); ?>><?= $adminuser['name']; ?></option>
                    <? } ?>
                    </select>
                </div>
