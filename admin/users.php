      ...
      <div class="row">
        ...
        <div class="row">
        	<div class="col-xs-12 col-sm-12">
            	<a href="../admin/user.php?action=add" class="btn btn-primary"><i class="fa fa-user-plus"></i> Add User</a>
                ...
                <tr>
                	<td><?= $user['name']; ?></td>
                	<td><?= $user['username']; ?></td>
                    <td><a href="../admin/user.php?username=<?= $user['username']; ?>"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <? 
						}
					}
