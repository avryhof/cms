<? 
	...
	$transactions = $db->query("SELECT * FROM `paypal_log` WHERE `action` = 'notify' ORDER BY `created`");
?>
<!DOCTYPE html>
...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <title>Paypal Transactions | Admin</title>
    <!-- InstanceEndEditable -->
    <? if ($local) { ?>
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        ...
        <tr>
        	<td><?= $trans['created']; ?></td>
            <td><?= $details1->address_name; ?></td>
            <td><?= $details1->payment_gross; ?></td>
            <td><a href="paypal_trans.php?id=<?= $trans['id']; ?>"><i class="fa fa-eye"></i></a></td>
        </tr>        
        <? 
			} 
		?>
