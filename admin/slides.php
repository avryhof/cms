  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        ...
        <? if ($parent > 0) { ?>
        <ol class="breadcrumb">
        	<li><a href="../admin/slides.php">Slides</a></li>
		</ol>
        <? } ?>
       	
        <a href="slide.php?action=add" class="btn btn-primary"><i class="fa fa-plus"></i> Add</a>
        ...
        <tr id="slide_<?= $slide['id']; ?>">
        	...
        	<td class="text-center"><?= ($slide['active'] == 1 ? '<i class="fa fa-check-square-o"></i>' : '<i class="fa fa-square-o"></i>'); ?></td>
        	<td><img src="<?= $slide['src']; ?>" style="width:64px;" class="img-thumbnail"></td>
            <td class="text-center"><a href="../admin/slide.php?id=<?= $slide['id']; ?>"><i class="fa fa-pencil"></i></a></td>
        </tr>
        <?
				}
			}
        ...
        <tfoot>
        <tr>
        	<td colspan="4">To Rename, Edit, or Delete a slide, Click the <i class="fa fa-pencil"></i> icon in the right-hand column.<br>To re-order slides, click and drag the item to a new position with the <i class="fa fa-bars"></i> icon in the sort column.</td>
        </tr>
        </tfoot>
        </table>
