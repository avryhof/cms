<?
    define('DB_HOST', 'mysql51-065.wc1.ord1.stabletransit.com');
    define('DB_USER', '904899_dairyb');
    define('DB_NAME', '904899_dairyb');
    define('DB_PASS', 'f7pu^3vE');
    
    $basepath = __DIR__;
    $baseurl = "http" . ((!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') ? "s" : "") . "://" . $_SERVER['HTTP_HOST'] . pathinfo($_SERVER['PHP_SELF'],PATHINFO_DIRNAME);
    require_once("../vendor/avryhof/database/database.php");    
